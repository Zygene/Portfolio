...
<head>
    ...
    <title>Robin Wilmes | Illustrations</title>
</head>
<body>
        ...
        <div class="wrapper">
            ...
            <div id="container-products">
                ...
                <?php
                    ...
                    $req = $bdd->prepare("SELECT * FROM products INNER JOIN categorie ON products.id_categorie = categorie.id WHERE products.id_categorie=1");
